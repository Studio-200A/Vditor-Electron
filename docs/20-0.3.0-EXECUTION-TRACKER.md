# Vditor-Electron 0.2.6 执行路线图与进度账本

> 原始目标：[`docs/19-0.2.6-VDITOR-4.0-MIGRATION-PLAN.md`](19-0.2.6-VDITOR-4.0-MIGRATION-PLAN.md)
> 建立日期：2026-09-09
> 目标版本：`0.2.6`
...
0.2.6 只做 Vditor 4.0 升级。发现无关问题先记录到 [`docs/00-ISSUES.md`](00-ISSUES.md)，不扩展版本范围。
